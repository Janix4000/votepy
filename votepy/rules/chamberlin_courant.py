...
from votepy.structure.structure import rule, get_implementation, impl, BaseAlgorithm
...
def chamberlin_courant(voting: Union[OrdinalElection, list[int]], size_of_committee: int, number_of_scored_candidates: int, algorithm: BaseAlgorithm) -> list[int]:
    ...
    """
    return solve(chamberlin_courant, voting, size_of_committee, number_of_scored_candidates, algorithm=algorithm)


@impl(chamberlin_courant, BruteForce)
def chamberlin_courant_brute_force(voting, size_of_committee, number_of_scored_candidates, algorithm: BruteForce = BruteForce()) -> list[int]:
...
def chamberlin_courant_greedy(voting, size_of_committee, number_of_scored_candidates, algorithm: Greedy = Greedy()) -> list[int]:
