from ordinal_election import OrdinalBallot, OrdinalElection
...
def chamberlin_courant_brute_force(voting: Union[OrdinalElection, list[int]], size_of_committee: int, number_of_scored_candidates: int) -> list[int]:
    ...
    return brute_force(voting, size_of_committee, lambda committee, voting: scoring_function(committee, voting, number_of_scored_candidates))
